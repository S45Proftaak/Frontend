...
render() {
    ...
    return (
        <div className="YourScore">
            <div className="Header"> <h3>{t("LeaderBoardScore.yourScore")}</h3> </div>
            {this.state.fetched ? (
                        <div className="YourScoreList">
                            <div className="YourScoreItem PaddedItem">
                                ...
                                <div>
                                    ...
                                    (this.state.fetchedData.positionInTime >= 3 ? "th" : 
                                    this.state.fetchedData.positionInTime === 1 ? "st" : 
                                    "nd")} - {this.state.fetchedData.inTimePoints} {t("LeaderBoardScore.Points")}
                                </div>
                            </div>
                            <div className="YourScoreItem PaddedItem">
                                ...
                                <div>
                                    ...
                                    (this.state.fetchedData.positionTooLate >= 3 ? "th" : 
                                    this.state.fetchedData.positionTooLate === 1 ? "st" : 
                                    "nd")} - {this.state.fetchedData.tooLatePoints} {t("LeaderBoardScore.Points")}
                                </div>
                            </div>
                            <div className="YourScoreItem-Borderless PaddedItem">
                                ...
                                <div>
                                    ...
                                    (this.state.fetchedData.positionGeneralRanking >= 3 ? "th" : 
                                    this.state.fetchedData.positionGeneralRanking === 1 ? "st" : 
                                    "nd")}  - {this.state.fetchedData.totalPoints} {t("LeaderBoardScore.Points")}
                                </div>
                            </div>
                        </div>
